...
namespace Nekretninte_Class
{
    class CetriZida
    {
        public void Proceed(IWebDriver driver, string price, string m2, string DeoGrada,string year,string loggia, string terrace, string phone, string intercom, string elevator,string bathroom, string toilet, string parkingSpace, string garage, string desc) // Price and M2 fill
        {
